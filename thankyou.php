...
<html class="no-js">
  ...
  <body>
    ...
    <div class="alert alert-success" style="margin: 20px 0;">
     <h4><i class="fas fa-check-circle"></i> Welcome to <?php echo $website ?>!</h4>
     <p><strong>Your account has been successfully created and activated!</strong></p>
     <p>You can now login with your credentials and start using the platform.</p>
    </div>
      <p><strong>Make sure to explore our features:</strong></p>
      <ul>
        <li>Account generators for various platforms</li>
        <li>Community chat to connect with other members</li>
        <li>Premium account management tools</li>
      </ul>
     <a class="btn btn-success btn-block" href="login.php"><i class="fas fa-sign-in-alt"></i> Login Now</a>
