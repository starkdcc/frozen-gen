        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <div class="sidebar-sticker">
              ...
              <a class="d-block text-gray my-2" href="https://www.digidripz.us">www.digidripz.us</a>
              <a class="d-block" href="https://www.facebook.com/ScottThomasServices">Private Sources Pm Me</a>
            </div>
          </li>
        </ul>
      </nav>
