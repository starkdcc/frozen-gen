...
<?php include("noob/header.php"); ?>
	...
	Waiting for purchase to complete, If it does not complete please message support with your paypal email and the package bought, or message <a href="https://www.facebook.com/profile.php?id=100018078933351" target="_blank">Owen </a> Or <a href="https://www.facebook.com/TheRealMVG" target="_blank">Robbie</a>
				</div>
		  ...
		  ?>
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="th-inner ">Pay By BTC</div>
                            <div class="fht-cell"></div>
                        </th>
                    </tr>
                                            </tbody>
                <tbody>
					...
					while ($row = mysqli_fetch_assoc($result)) {
						...
						<td>".'<a target="_blank" class="btn btn-primary" href="https://coingate.com/pay/package01">Buy With Btc</a>'."</td>
						</td>
						</tr>
						";
					}
