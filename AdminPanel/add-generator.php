...
if (isset($_POST['addgenerator'])){
	...
	mysqli_query($con, "INSERT INTO `generators` (`name`, `link`, `about`, `stock`, `stockcolor`) VALUES ('$name', '$link', '$about', '$stock', '$stockcolor')") or die(mysqli_error($con));
...
if (isset($_GET['deletegenerator'])){
	...
	echo '
		<script>
			window.history.replaceState("object or string", "Title", "add-generator.php");
		</script>
	';
}
...
if (isset($_POST['editgenerator']) & isset($_POST['generatorid'])){
	...
	mysqli_query($con, "UPDATE `generators` SET `link` = '$link' WHERE `id` = '$id'") or die(mysqli_error($con));
	mysqli_query($con, "UPDATE `generators` SET `about` = '$about' WHERE `id` = '$id'") or die(mysqli_error($con));
	mysqli_query($con, "UPDATE `generators` SET `stock` = '$stock' WHERE `id` = '$id'") or die(mysqli_error($con));
	mysqli_query($con, "UPDATE `generators` SET `stockcolor` = '$stockcolor' WHERE `id` = '$id'") or die(mysqli_error($con));
                  ...
                  <center><h4 class="card-title">News & Updates</h4></center>
                    ...
                    <div class="table-sorter-wrapper col-lg-12 table-responsive">
                      <table id="sortable-table-2" class="table table-striped">
								...
								<form action="add-generator.php" method="POST">
									  ...
									  <div class="panel panel-info">
										  <div class="panel-heading">
											  <h4 class="panel-title">
												  ...
												  <a href="add-generator.php?deletegenerator='.$row[id].'" class="btn btn-primary btn-danger pull-right"><i class="fa fa-trash"></i></a>
