                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                            <a data-toggle="modal" data-target="#add-news" class="waves-effect active"><i class="ti-bell"></i><span> Add New Post </span></span></a>
                            </li>
                  ...
                  ?>
                            ...
                            <li>
                                <a href="yourposts.php" class="waves-effect active"><i class="ti-angle-up"></i><span> Customer Posts </span> </a>
                            </li>
...
<div class="col-lg-12">
                        ...
                        <?php
                                    ...
                                    $result = mysqli_query($con, "SELECT * FROM `userpost`");
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="panel panel-color panel-primary">
                                    ...
                                    <div class="panel-heading"> 
                                        ...
                                        <h3 class="panel-title">'.$row['title'].' <a class="btn btn-primary pull-right" href="post.php?id='.$row['id'].'">View Post</a></h3>
